...
const EditProfile: React.FC = () => {
  ...
  const getTabTriggerClasses = (tabValue: string) => {
    return cn(
      ...
      "data-[state=active]:text-vanta-neon-blue data-[state=active]:bg-transparent", // Ensure transparent background for active tab
    ...
    <div className="min-h-screen bg-vanta-blue-dark text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs defaultValue="profile" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="profile" className="bg-vanta-blue-medium rounded-xl p-0">
            <ProfileSettingsTab />
          </TabsContent>
          <TabsContent value="security" className="bg-vanta-blue-medium rounded-xl p-0">
            <SecuritySettingsTab />
          </TabsContent>
