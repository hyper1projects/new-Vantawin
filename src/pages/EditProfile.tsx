...
// Assuming these imports are correct paths to your shadcn/ui components
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { cn } from '@/lib/utils';
// Assuming these are your custom tab content components
...
      "bg-transparent text-vanta-text-light hover:text-vanta-neon-blue", // Triggers are transparent
...
  return (
    // This container will scroll if its content overflows
...
        {/* FIX APPLIED HERE: Added 'bg-transparent' to the TabsList 
          to remove the default white/gray background.
        */}
        <TabsList className="grid w-full grid-cols-3 p-0 pb-4 mb-8 border-b border-gray-700/50 bg-transparent">
