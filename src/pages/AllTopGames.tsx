...
const AllTopGames: React.FC = () => {
  ...
  return (
    <div className="p-4">
      ...
      <SectionHeader title="All Top Games" className="mb-6" textColor="text-vanta-text-light" />
      ...
      <div className="w-full flex flex-col space-y-4 px-1">
        {filteredGames.length > 0 ? (
          ...
          <p className="text-vanta-text-light text-center py-8">No games available for this filter.</p>
        )}
      </div>
    </div>
  );
