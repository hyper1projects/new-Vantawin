...
const MatchCard: React.FC<MatchCardProps> = ({ game }) => {
  return (
    <Link to={`/games/${game.id}`} className="relative p-[3px] rounded-[25px] bg-gradient-to-t from-[#9A3FFE] to-[#00EEEE] w-[230px] h-[280px] flex-shrink-0 cursor-pointer hover:scale-[1.02] transition-transform duration-200">
