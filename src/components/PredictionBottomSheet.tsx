              ...
              return (
                <div className="relative mb-4">
                  ...
                  <div className="relative text-[#93B5EF] text-sm font-medium text-center px-6 py-3 border-2 border-[#93B5EF]/40 rounded-xl bg-gradient-to-br from-[#016F8A]/30 to-[#016F8A]/10 backdrop-blur-sm flex items-center justify-center gap-2 shadow-lg shadow-[#93B5EF]/10">
                    ...
                    <span className="text-xs opacity-80 uppercase tracking-wider px-2 py-1 bg-[#93B5EF]/20 rounded-full">[{side}]</span>
                  </div>
                </div>
              );
            } else {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onOpenChange}>
      <DrawerContent className="bg-vanta-blue-medium text-vanta-text-light border-t border-gray-700 rounded-t-[27px] h-auto max-h-[90vh] flex flex-col">
        <DrawerHeader className="pt-4 pb-2 px-4">
        ...
        {selectedGame ? (
          showSuccess ? (
            <div className="flex flex-col items-center justify-center p-10 space-y-4 h-auto min-h-[16rem] relative">
              {/* Confetti particles */}
              ...
              <div className="relative z-10 h-20 w-20 bg-vanta-neon-green/20 rounded-full flex items-center justify-center animate-bounce-in">
            ...
            <div className="flex flex-col flex-grow p-4 overflow-y-auto">
              ...
              <div className="mb-6 p-4 rounded-xl bg-gradient-to-br from-yellow-500/10 via-transparent to-purple-500/10 border border-yellow-400/30 hover:border-yellow-400/50 transition-all">
                <div className="flex justify-between items-center">
                  ...
                  <div className="relative">
                    ...
                    <span className={`relative text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600 transition-all duration-300 ${potentialWinXP > 0 ? 'scale-110' : 'scale-100'}`}>
              ...
              <DrawerFooter className="p-0 mt-auto">
                <Button
                  className={`w-full py-3 text-lg font-bold rounded-xl relative overflow-hidden group transition-all duration-300 ${!isSubmitting && hasEntry && typeof predictionAmount === 'number' && predictionAmount >= 50 && predictionAmount <= 200
