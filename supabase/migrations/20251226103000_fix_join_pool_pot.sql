-- Migration: Fix join_pool prize logic
-- Date: 2025-12-26
-- Purpose: Stop increasing total_pot when a user joins. The prize pool should be fixed.
...
BEGIN
    ...
    -- REMOVED: Incrementing total_pot
    -- UPDATE public.pools SET total_pot = total_pot + v_pool_fee WHERE id = p_pool_id;
